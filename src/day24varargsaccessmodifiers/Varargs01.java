...
public class Varargs01 {
	...
	public static void main(String[] args) {
		// Varargs demek Variable Arguments demek.
		// Bir method oluþturduðumuzda argument olarak istedigimiz kadar
		//argument girebilmemizi saðlar. 
